...
export default class PositionCalculator {
    ...
    static outputPosition(): void {
        const positions = FileParser.parseFile('./Day_2/Problem_1/model.txt');
        positions.pop();
        console.log('Position: ', this.calculatePosition(this.getSum(positions)));
    }
}

PositionCalculator.outputPosition();
